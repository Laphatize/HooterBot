...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('partner_message')
        .setDescription(`ADMIN | Generate embed in \#server-announcements to share messages from partner servers.`)
}

    
//     name: 'partner_message',
//     description: 'ADMIN | Generate embed in \#server-announcements to share messages from partner servers.',
//     options: [
//         {
//             name: `partner_name`,
