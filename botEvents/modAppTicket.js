            ...
            await interaction.guild.channels.create(`${modAppChannelName}`, {
                ...
                .then(async modApplicantChannel => {
                    ...
                    let newTicketEmbed = new discord.MessageEmbed()
                        ...
                        .setDescription(`\n**Thank you for your interest in our moderator position!**\n\nTo help the admins assess applicants, HooterBot will ask you a few questions. There are a total of **5 questions**. HooterBot will ask each question one at a time. Submit your response to the current question in a **single message**. HooterBot will follow up with the next question after responding to the current question. If you need to append or change your response, please edit the message responding to the question.`)
