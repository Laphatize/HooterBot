...
module.exports = {
	...
	async execute(message, client) {
        ...
        if (command.dmUse == false              // "Can't use in DMs"
            && command.guildUse == true         // "Can use in guilds"
            && message.channel.type === 'dm')   // "Location is a DM"
            {
        ...
        if (command.dmUse == true 
            && command.guildUse == false
