...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('phillyfind')
        .setDescription(`Search for places on campus or across Philly by name and get an address and map. (🤖｜bot-spam) [30s]`)
}
...
//                     .setDescription(`**Query:** ${locationName}\n**Result:** ${resultName}\n${resultAddress}\n**See more results [on Google Maps](${encodeURI(`https://www.google.com/maps/search/?api=1&query=${locationName}`)})**\n*The red marker is the Bell Tower.*`)
