...
module.exports = {
	...
	async execute(guild, client) {
        ...
        let ticketCategory = await guild.channels.create(`VERIFICATION (OPEN: 0) [0/50]`, {
            ...
            reason: `Part of the verification process ran by HooterBot. Used by the verification process.`
        })
